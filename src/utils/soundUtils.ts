...
import hypercubeSoundFile from '../assets/hypercube.mp3';
...
const hypercubeSound = new Audio(hypercubeSoundFile);
...
export const playHypercubeSound = () => {
  hypercubeSound.currentTime = 0;
  hypercubeSound.play().catch(() => {
    // Ignore errors if sound can't play
  });
}; 